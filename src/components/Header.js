    ...
    <>
      <nav className="d-flex">
          ...
          <ul className="column-center">
            <li className="tab active">
              ...
              <svg
                ...
                height="28"
                width="28"
                className="fill-primary-button-background"
              >
        ...
        <div className="column-right">
          ...
          <div
            className="action-button justify-content-end align-items-end"
            style={{
              backgroundImage:
          ...
          >
            <i
              ...
              style={{ filter: "var(--filter-always-white)" }}
            ></i>
          </div>
        </div>
      </nav>
